...
{
    internal class GroupingQueryable<TKey, TEntity, TEntity2> : GroupingQueryable, IGroupingQueryable<TKey, TEntity, TEntity2> where TEntity : IEntity where TEntity2 : IEntity
    {
