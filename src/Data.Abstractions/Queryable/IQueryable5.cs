...
namespace Mkh.Data.Abstractions.Queryable
{
        ...
        where TEntity5 : IEntity, new()
    {
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> OrderBy(string colName);
        ...
        /// <param name="colName">列名</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> OrderByDescending(string colName);
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> OrderBy(Sort sort);
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> OrderBy<TKey>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TKey>> expression, SortType sortType);
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> WhereNotIn<TKey>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TKey>> key, IEnumerable<TKey> list);
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> SubQueryEqual<TKey>(Expression<Func<TEntity, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> SubQueryNotEqual<TKey>(Expression<Func<TEntity, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> SubQueryGreaterThan<TKey>(Expression<Func<TEntity, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> SubQueryGreaterThanOrEqual<TKey>(Expression<Func<TEntity, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> SubQueryLessThan<TKey>(Expression<Func<TEntity, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> SubQueryLessThanOrEqual<TKey>(Expression<Func<TEntity, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> SubQueryIn<TKey>(Expression<Func<TEntity, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> SubQueryNotIn<TKey>(Expression<Func<TEntity, TKey>> key, IQueryable queryable);
        ...
        /// </summary>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> Select<TResult>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TResult>> selectExpression);
        ...
        /// </summary>
        /// <returns></returns>
        Task<TResult> Max<TResult>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TResult>> expression);

        /// <summary>
        /// 获取最小值
        /// </summary>
        /// <returns></returns>
        Task<TResult> Min<TResult>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TResult>> expression);

        /// <summary>
        /// 求和
        /// </summary>
        /// <returns></returns>
        Task<TResult> Sum<TResult>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TResult>> expression);

        /// <summary>
        /// 求平均值
        /// </summary>
        /// <returns></returns>
        Task<TResult> Avg<TResult>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TResult>> expression);
