...
namespace Mkh.Data.Abstractions.Queryable
{
        ...
        where TEntity4 : IEntity, new()
    {
        ...
        /// <param name="elseExpression"></param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> WhereNotNull(string condition, Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, bool>> ifExpression, Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, bool>> elseExpression);
        ...
        /// <param name="elseExpression"></param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> WhereNotNull(object condition, Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, bool>> ifExpression, Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, bool>> elseExpression);
        ...
        /// <param name="elseExpression"></param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> WhereNotEmpty(Guid condition, Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, bool>> ifExpression, Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, bool>> elseExpression);
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> SubQueryEqual<TKey>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> SubQueryNotEqual<TKey>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> SubQueryGreaterThan<TKey>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> SubQueryGreaterThanOrEqual<TKey>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> SubQueryLessThan<TKey>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> SubQueryLessThanOrEqual<TKey>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> SubQueryIn<TKey>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TKey>> key, IQueryable queryable);
        ...
        /// <param name="queryable">子查询的查询构造器</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> SubQueryNotIn<TKey>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TKey>> key, IQueryable queryable);
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4> Select<TResult>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TResult>> expression);
        ...
        /// </summary>
        /// <returns></returns>
        Task<TResult> ToMax<TResult>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TResult>> expression);

        /// <summary>
        /// 获取最小值
        /// </summary>
        /// <returns></returns>
        Task<TResult> ToMin<TResult>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TResult>> expression);

        /// <summary>
        /// 求和
        /// </summary>
        /// <returns></returns>
        Task<TResult> ToSum<TResult>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TResult>> expression);

        /// <summary>
        /// 求平均值
        /// </summary>
        /// <returns></returns>
        Task<TResult> ToAvg<TResult>(Expression<Func<TEntity, TEntity2, TEntity3, TEntity4, TResult>> expression);
